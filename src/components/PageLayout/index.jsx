...
export const PageLayout = () => {
  ...
  return (
    ...
    <C.Container bg={movies[movieId].background}>
      ...
      <C.RightContent>
        <C.TopContent>
          <img src={movies[movieId].logo} alt='Logo Spiderman homecomming' title='Spiderman homecomming'></img>
          <C.Description>
            <C.Pills>
              <ul>
                <li>Ano: {movies[movieId].year}</li>
                <li>Diretor: {movies[movieId].director}</li>
              </ul>
            </C.Pills>
            <p><strong>Sinopse:</strong>&nbsp; {movies[movieId].sinopse}</p>
          </C.Description>
          <IconContext.Provider value={{ color: 'var(--primary-color)', size: '2rem' }}>
            <C.TrailerButton>
              <a href={movies[movieId].trailer} target='_blank'>
                <RiPlayCircleFill />
                <span className='label'>Assistir Trailer</span>
              </a>
              <a href={movies[movieId].imdb} target='_blank'>
        ...
        <C.BottomContent>
          <Fancybox options={{ infinite: false }}>
            <C.Gallery id='gallery'>
              <ul>
                <li>
                  <a data-fancybox='gallery' href={movies[movieId].images.image1}>
                    <img src={movies[movieId].images.image1} alt='Cena do filme Homem aranha'></img>
                  </a>
                </li>
                <li>
                  <a href={movies[movieId].images.image2} data-fancybox='gallery'>
                    <img src={movies[movieId].images.image2} alt='Cena do filme Homem aranha'></img>
                  </a>
                </li>
                <li>
                  <a href={movies[movieId].images.image3} data-fancybox='gallery'>
                    <img src={movies[movieId].images.image3} alt='Cena do filme Homem aranha'></img>
                  </a>
                </li>
              </ul>
            </C.Gallery>
